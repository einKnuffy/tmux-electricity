...
tmux_set window-status-current-format "#[fg=$G06,bg=$G06]$right_arrow_icon#[fg=$TC,bold] #I:#W#F #[fg=$BG,bg=$BG,nobold]█" # "#[fg=$BG,bg=$G06]█#[fg=$TC,bold] #I:#W#F #[fg=$G06,bg=$BG,nobold]$right_arrow_icon"
